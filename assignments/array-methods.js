...
// Problem 1 : first names to last names :0
runners.forEach( item => item.first_name = item.last_name);
console.log(runners);

// Problem 2 : runners who donated 200$
let vip = runners.filter((runner) => {
    return runner.donation >= 200})
console.log(vip);

// Problem 3 : emailing runners to thank for donation and welcome
